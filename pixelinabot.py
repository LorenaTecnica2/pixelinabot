...
# -------------------------------
# RESPUESTAS ALEATORIAS MÁS DIVERTIDAS
# -------------------------------
wifi_msgs = [
    "¡No es tu compu! El WiFi del cole está tomando mate ☕",
    "Red inestable… parece que alguien desconectó los cables para jugar a la escondida 🕵️‍♂️",
    "¡Ups! El WiFi se fue de recreo 🏃💨",
    "Red caída. Pixelina recomienda reiniciar la compu y rezar 🙏💻"
]

tareas_msgs = [
    "¿Tenés tareas pendientes? ¡A por ellas! 📘💪",
    "Recordá anotar las tareas en la libreta digital 📓✨",
    "¡Pixelina dice: nada de Netflix antes de entregar! 🍿🚫",
...
oraculo_msgs = [
    ...
    "Alguien te pedirá ayuda para copiar… digo, colaborar 🤫",
